...
```swift
DesignSystem.configure(theme: AdaptiveTheme(colorStory: ColorStory(brand: .{color}, surface: Color(light: Color(hex: "{surface_hex_light}"), dark: Color(hex: "{surface_hex_dark}")))))
```
